...
- name: Akamai API Report Security Event Details
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/details/master/_listings/akamai/etp-report-v1-configs-configid-threat-events-details-get.md
x-common:
- type: x-base
