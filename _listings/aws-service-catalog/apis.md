...
created: "2018-08-26"
modified: "2018-08-26"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/details/master/_listings/aws-service-catalog/apis.md
...
- name: AWS Service Catalog API - List Record History
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/details/master/_listings/aws-service-catalog/actionlistrecordhistory-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/details/master/_listings/aws-service-catalog/actionlistrecordhistory-get-openapi.md
- name: AWS Service Catalog API - List Record History
  x-api-slug: actionlistrecordhistory-get
  description: |-
    Returns a paginated list of all performed requests, in the form of RecordDetails
